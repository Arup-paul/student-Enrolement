          ...
          <div class="card col-lg-4 mx-auto">
            <div class="card-body px-5 py-5">
              <h3 class="card-title text-left mb-3">Login</h3>
               ...
               <h2 class="alert-danger" style=" font-size: 18px;text-align: center;">
                     <?php
              ...
              <form method="post" action="{{url('/adminlogin')}}">
                ...
                <div class="form-group">
                  <label>Email *</label>
                  <input name="admin_email" placeholder="Enter Your Name" type="email" class="form-control p_input">
                </div>
                <div class="form-group">
                  <label>Password *</label>
                  <input name="admin_password" placeholder="Enter Your Password" type="text" class="form-control p_input">
                </div>
