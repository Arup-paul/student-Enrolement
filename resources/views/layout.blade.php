...
<head>
  ...
  <!-- endinject -->
  <link rel="stylesheet" href="{{asset('images/favicon.html')}}">
</head>
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="{{URL::to('/admin_dashboard')}}"><img src="" alt="Student Enrolement"></a>
      </div>
          ...
          <ul class="nav">
           ...
           <li class="nav-item">
              ...
              <div class="collapse" id="sidebar_layouts1">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/eee_teacher')}}">EEE</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/cse_teacher')}}">CSE</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/bba_teacher')}}">BBA</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/ece_teacher')}}">ECE</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/me_teacher')}}">ME</a>
                  </li>
                </ul>
              </div>
            </li>
